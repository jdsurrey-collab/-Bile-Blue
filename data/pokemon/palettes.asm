MonsterPalettes:
	...
	db PAL_BROWNMON   ; CLEFFA
	db PAL_BROWNMON   ; IGGLYBUFF
	db PAL_BROWNMON   ; TOGEPI
	db PAL_BROWNMON   ; TOGETIC
	db PAL_PINKMON    ; NATU
	db PAL_PINKMON    ; XATU
	...
	db PAL_GRAYMON    ; SUDOWOODO
	db PAL_BLUEMON    ; POLITOED
	db PAL_GREENMON   ; HOPPIP
	db PAL_GREENMON   ; SKIPLOOM
	db PAL_GREENMON   ; JUMPLUFF
	db PAL_BROWNMON   ; AIPOM
