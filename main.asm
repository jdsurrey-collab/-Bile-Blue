...
; Sprite ROM bank per species (see home/pics.asm). Floating so the linker can
; place it; generated by tools/gen2_emit.py.
SECTION "Mon Pic Banks", ROMX

INCLUDE "data/pokemon/pic_banks.asm"
